...
class _LoginEmailState extends State<LoginEmail> {
  ...
  ThemeData darkTheme=ThemeData(
      ...
      iconTheme: IconThemeData(color: Colors.green[200]), bottomAppBarColor: Colors.black,
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                    borderSide:
                        BorderSide(color: Colors.green[200]!, width: 2.0),
                    borderRadius: BorderRadius.all(Radius.circular(32.0)),
                  ),
                ),
              ),
              ...
              Rounded_Button(
                onPressed: () async {
                  ...
                  try {
                    ...
                    if (oldUser != null) {
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>HomePage(lightmode,widget.gridView))) ;
                    }
